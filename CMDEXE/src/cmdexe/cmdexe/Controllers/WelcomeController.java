...
public class WelcomeController {
	...
	private void WriteWelcomeBooleanToFile() throws IOException {
		...
		FilesAndFolders.ReadInFile(System.getProperty("user.dir") + "\\cmdexe", "SystemInformation.dir"); 
		
		if(FilesAndFolders.LineText.size() == 2) {
			FilesAndFolders.WriteToFile(System.getProperty("user.dir") + "\\cmdexe", "SystemInformation.dir", "\nSeenWelcomePage=\"true\"");
		}
    }
}
